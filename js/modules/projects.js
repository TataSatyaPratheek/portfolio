/**
 * projects.js - Module for handling projects data and rendering
 * Manages fetching project data, rendering project cards and detail pages.
 */
...
const ProjectsModule = {
    ...
    config: {
        ...
        perPage: 6, // Number of projects to load per page
     ...
     * @returns {Promise<Array>} - Promise that resolves with projects data
     */
    async fetchProjects() {
